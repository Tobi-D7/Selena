                                             ...
                                             ast_node *ASTNode)
{
  ...
  if (ASTNode->Type == ast_node::DIVIDE)
  {
    ...
    In.Dst = (neocode_variable){
        "", "", ast_node::STRUCT, Function->Program->Registers.AllocTemp(), 0, {0}, 0};
...
neocode_program CGNeoBuildProgramInstance(ast_node *ASTNode, symtable *S)
{
  ...
  CGNeo.SymbolTable = S;
  Program.Registers = {};
  Program.Globals.push_back((neocode_variable){"NS_Position",
                                               "vec4",
                                               ast_node::STRUCT,
  ...
  /*Program.Globals.push_back((neocode_variable){"NS_Normal",
                                               ...
                                               {0},
                                               0});*/
  Program.Globals.push_back((neocode_variable){"NS_Color",
                                               "vec4",
                                               ast_node::STRUCT,
                                               Program.Registers.AllocOutput(),
  ...
  Program.Globals.push_back((neocode_variable){"NS_Texture2",
                                               ...
                                               {0},
                                               0});
  Program.Globals.push_back((neocode_variable){"NS_View",
                                               "vec4",
                                               ast_node::STRUCT,
                                               Program.Registers.AllocOutput(),
